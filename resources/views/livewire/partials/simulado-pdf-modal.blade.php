        ...
        >
            ...
            >
                ...
                <div class="flex gap-2 justify-end">
                    ...
                    @if (($nativeSave ?? false) && config('nativephp-internal.running'))
                        {{-- Desktop NativePHP: salva via diálogo nativo do SO (SimuladoPage::salvarPdfNativo) --}}
                        <button
                            type="button"
                            x-on:click="$wire.salvarPdfNativo([prova_branca && 'prova_branca', gabarito && 'gabarito', respostas && 'respostas'].filter(Boolean)); modalPdf = false"
