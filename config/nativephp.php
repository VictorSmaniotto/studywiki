...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.rockandcode.studywiki'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'StudyWiki — sua vault de estudos com geradores de IA ancorados nas fontes.'),
